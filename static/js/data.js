const CBR_DATA = {
  ...
  sessions: [
    {
      ...
      activities: [
        { id: 1, text: "Read and finish The Power in Consistent Bible-Reading Discipline (PDF)." },
    ...
    },
    {
      ...
      activities: [
        { id: 7, text: "Read carefully all the information and instructions in the CBR manual." },
    ...
    },
    {
      ...
      activities: [
        { id: 22, text: "Use the PERSONS method to study Faithfulness (page 7)." },
  ...
  cards: [
    ...
    { cardId: 7, chaptersTarget: 7, ertTarget: "04:15", description: "Card 7: 7 Chapters, Target Waking Time: 4:15 AM" }
  ]
};
